...
<div class="top">
    ...
    <a href="" target="_blank" style="float:right">xue's blog</a>
</div>
<div class="content">
...
<br /><br />
<button class="bt" onclick="window.open('')">MY CSDN BLOG</button>
...
<div class="footer">
    ...
    <p>你好 我是xue</p><br />
    <a href="" target="_blank"><img class="someimg" src="./hou.png" alt="" width="30"></a>
    <abbr title="QQ账号：88888888"><img class="someimg" src="./qq.png" alt="" width="30"></abbr>
    <abbr title="邮箱：888888888@qq.com"><img class="someimg" src="./mail.png" alt="" width="30"></abbr>
</div>
<script>
    ...
    (function (window, document, undefined) {
        ...
        init();
        function init() {
            css(".heart{width: 10px;height: 10px;position: fixed;background: #f00;transform: rotate(45deg);-webkit-transform: rotate(45deg);-moz-transform: rotate(45deg);}.heart:after,.heart:before{content: '';width: inherit;height: inherit;background: inherit;border-radius: 50%;-webkit-border-radius: 50%;-moz-border-radius: 50%;position: absolute;}.heart:after{top: -5px;}.heart:before{left: -5px;}");<!-- flag{testflag}-->
            attachEvent();
            gameloop();
        }
        function gameloop() {
